...
swiper__WEBPACK_IMPORTED_MODULE_2__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Autoplay]);
const swiperPartners = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.partners__swiper', {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Autoplay],
  loop: true,
  allowTouchMove: false,
  // отключаем свайп
  slidesPerView: 'auto',
  // чтоб не прыгал по 2-3 слайда
  speed: 8000,
  // скорость перехода (выше — медленнее движение)
  autoplay: {
    delay: 0,
    // ноль — бесконечно
    disableOnInteraction: false
  },
  spaceBetween: 40 // отступы между логотипами
});
})();
